   ...
   <form action="#" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="Confirm Password" name="guests">
         </div>
...
if(isset($_POST['send']))
{
    ...
    $query = "insert into form(name,email,phone,address,password,cpassword) values('$name','$email','$phone','$add','$pwd','$cpwd')";

...
<section class="booking">
   ...
   <form action="#" method="post" class="book-form" autocomplete="off">

     <div class="flex">
         
         <div class="inputBox">
            <span><h2>Email :</h2></span>
             <input type="text" value="admin@gmail.com" name="location" disabled>
         </div>
...
if(isset($_POST['send']))
{
   // $username = $_POST['email'];
    ...
    $query = "select * from user where email = 'admin@gmail.com' && password ='$pass'";
